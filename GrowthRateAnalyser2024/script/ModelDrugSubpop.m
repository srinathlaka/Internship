function [Data,parametersD] = ModelDrugSubpop(filename,d0,f0,q01,mu01,d01,Data0,parameters,parameters0)
...
%define the model
blackboxmodel = @ModelBaranyiDrugSubpop;
...
%initial guess
P0 = [parametersD.d0,parametersD.f0,parametersD.q01,parametersD.mu01,parametersD.d01];
%eventual boundaries
lb = [-inf,0,-inf,-inf,-inf];
