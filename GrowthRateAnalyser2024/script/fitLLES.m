function [Data,parameters] = fitLLES(Data,tin,tfin,parameters0,i,parameters)
...
%initial guess
P0 = [param.mu,param.x0,param.k,param.klag,param.tlag];
%eventual boundaries
...
%minimize chi square
%[fittedparameters,fval] = fminsearchbnd(@(P) minimizeChiSquareLlinearS(P,blackboxmodel,time,param,Data),P0,lb,ub,options);
