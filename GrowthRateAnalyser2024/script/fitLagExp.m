function [Data,parameters] = fitLagExp(Data,tin,tfin,parameters0,i,parameters)
...
%model chi square
modelChi = @(P) minimizeChiSquareLagExp(P,blackboxmodel,time,param,Data);
...
parameters.s{i}(3) = fittedparametersStd(3);
