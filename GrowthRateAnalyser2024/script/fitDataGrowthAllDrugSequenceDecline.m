function [Datamedium,Datadrug,parametersmedium,parametersdrug] = fitDataGrowthAllDrugSequenceDecline(WellsPlate,filename,Databkg,parametersmedium,mu0,q0,k0,d0,g,tin,tdrug,tfin)
...
k0 = max(Datamedium.XmeanSmooth);
x0d = Datadrug.XmeanSmooth(1);
k0d = max(Datadrug.XmeanSmooth);
parametersmedium.tdrug = Datamedium.time(tdrug);

[Datamedium,parametersmedium] = fitBaranyiSaturationDecline(Datamedium,mu0,x0,q0,k0,g,tin,tdrug,tfin,parametersmedium);
%[Datadrug,parametersdrug] = fitBaranyiSaturationDrugSequenceDecline(Datadrug,x0d,k0d,g,d0,tin,tdrug,tfin,parametersmedium);
%[Datadrug,parametersdrug] = fitBaranyiSaturationDrugSequenceDecline2(Datadrug,x0d,d0,tin,tdrug,tfin,parametersmedium);
[Datadrug,parametersdrug] = fitBaranyiSaturationDrugSequenceDecline3(Datadrug,x0d,d0,tin,tdrug,tfin,parametersmedium);
