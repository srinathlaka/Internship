function [Data0,parameters0] = finerBaselineFlexy1(filename0,tin,tfin,WellsPlate,minut,a0,k0)
...
if ~isempty(k0)
    ...
    blackboxmodel0 = @Model0; %non linear
    ...
    blackboxmodel0 = @ModelLinear; %linear
    P00 = [parameters0.a0];
    ...
    fprintf('a0 = %f, b0 = %f \n',fittedParameters0(1),parameters0.b0);

    parameters0.a0 = fittedParameters0(1);
    parameters0.b0 = X0mean(1);
    parameters0.k0 = k0;
    Xbest = ModelLinear(time,parameters0);
    Data0.Xmodel = Xbest;
...
if tin>1
    if ~isempty(k0)
        parameters0.b0 = X0mean(1) + k0.*((time(1))./(time(1)+a0));
    else
