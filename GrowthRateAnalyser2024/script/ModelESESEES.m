function Xm = ModelESESEES(time,parameters)
...
(((((x0.*(exp(mu.*Tswitch))./(1+(x0./k).*(exp(mu.*Tswitch)-1)))).*(exp(kswitch.*(Tswitch2-Tswitch)))./(1+(((x0.*(exp(mu.*Tswitch))./(1+(x0./k).*(exp(mu.*Tswitch)-1))))./k2).*(exp(kswitch.*(Tswitch2-Tswitch))-1))).*(exp(kswitch2.*(Tdeath-Tswitch2)))).*(exp(mu.*(time-Tdeath))./(1+(((((x0.*(exp(mu.*Tswitch))./(1+(x0./k).*(exp(mu.*Tswitch)-1)))).*(exp(kswitch.*(Tswitch2-Tswitch)))./(1+(((x0.*(exp(mu.*Tswitch))./(1+(x0./k).*(exp(mu.*Tswitch)-1))))./k2).*(exp(kswitch.*(Tswitch2-Tswitch))-1))).*(exp(kswitch2.*(Tdeath-Tswitch2))))./k3).*(exp(mu.*(time-Tdeath))-1)))).*heaviside(time-Tdeath);
