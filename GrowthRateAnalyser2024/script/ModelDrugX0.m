function [Data,parametersD] = ModelDrugX0(filename,d0,x0,Data0,parameters,parameters0)
...
%minimize chi square
[fittedParameters,fval] = fminsearchbnd(@(P) minimizeChiSquareDrugX0(P,blackboxmodel,time,parametersD,Data,parameters),P0,lb,ub,options);
