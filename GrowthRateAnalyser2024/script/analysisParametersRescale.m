function analysisParametersRescale(parameterAnalisis)
...
condition_media1 = parameterAnalisis.condition_media1;
condition_media2 = parameterAnalisis.condition_media2;
...
[convertf,convertp,units_label,units_labelf] = loadandplotDataset(inputs_folderData,name_condition,parameter_to_plot,condition_names,condition_ylabel,convert_unit,condition_value);

%% rescale on 0 mec with conversion to dbl time

rescaleGR(inputs_folderData,name_condition,condition_ylabel,units_label,condition_media1,condition_media2,condition_value,convertf,convertp,units_labelf)
