function [Data,parameters] = fitESED(Data,tin,tfin,parameters0,i,parameters)
...
%initial guess
P0 = [param.mu,param.x0,param.k,param.kdeath,param.tdeath,param.tswitch,param.kswitch]; %%%%%%%%%%%%%%%%%%%%%%%%%%%
%eventual boundaries
...
Kmin = min(X);
Kmax = max(X);
lb = [-inf,Xmin,Kmin,-inf,time(tswitch),time(tin),-inf]; %%%%%%%%%%%%%%%%%%%%%%%%%%%
