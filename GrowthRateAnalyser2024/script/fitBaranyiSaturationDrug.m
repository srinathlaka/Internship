function [Data,parameters] = fitBaranyiSaturationDrug(Data,mu0,x0,q0,k0,d0,tin,tfin,parameters)
...
%define the model
blackboxmodel = @ModelBaranyiSaturationDrug;
