function [Data,parameters] = fitLinear(Data,tin,tfin,parameters0,i,parameters)
...
%minimize chi square
%[fittedparameters,fval] = fminsearchbnd(@(P) minimizeChiSquareLinear(P,blackboxmodel,time,param,Data),P0,lb,ub,options);
...
% best fit
param.x0 = fittedparameters(1);
param.klag = fittedparameters(2);
...
fprintf('x0 = %f, klag = %f, residual chi2/DOF = %f, p = %f \n',fittedparameters(1),fittedparameters(2),SigmaSq,p)
