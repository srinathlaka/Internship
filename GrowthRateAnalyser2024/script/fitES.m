function [Data,parameters] = fitES(Data,tin,tfin,parameters0,i,parameters)
...
fprintf('mu = %f, x0 = %f, k = %f, residual chi2/DOF = %f, p = %f \n',fittedparameters(1),fittedparameters(2),fittedparameters(3),sigmaSq,p)
