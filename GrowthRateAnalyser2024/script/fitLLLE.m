function [Data,parameters] = fitLLLE(Data,tin,tfin,parameters0,i,parameters)
...
%initial guess
P0 = [param.mu,param.x0,param.klag,param.tlag,param.q0];
%eventual boundaries
...
%minimize chi square
%[fittedparameters,fval] = fminsearchbnd(@(P) minimizeChiSquareLlinearLexp(P,blackboxmodel,time,param,Data),P0,lb,ub,options);
...
param.tlag = fittedparameters(4);
param.q0 = fittedparameters(5);
...
fprintf('mu = %f, x0 = %f, klag = %f, tlag = %f, q0 = %f, residual chi2/DOF = %f, p = %f \n',fittedparameters(1),fittedparameters(2),fittedparameters(3),fittedparameters(4),fittedparameters(5),SigmaSq,p)
